...
import com.example.lesson_koltin_6_activity_navigation.databinding.ActivityMenuBinding
...
class MenuActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.optionButton.setOnClickListener { onOptionsPressed() }
    ...
    private fun onAboutPressed() {
        val intent = Intent(this, AboutMenu::class.java)
        startActivity(intent)
    }
